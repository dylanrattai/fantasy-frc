  ...
  return (
    ...
    >
      ...
      <Tabs.Panel value="home">
        ...
        />
        <ParagraphBoxComponent
          title={"Fantasy FRC Scoring"}
          body={
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Gravida in fermentum et sollicitudin ac orci phasellus egestas. Eu sem integer vitae justo eget magna fermentum iaculis eu. Euismod nisi porta lorem mollis aliquam. Adipiscing enim eu turpis egestas pretium. Senectus et netus et malesuada fames ac turpis. Egestas diam in arcu cursus euismod quis viverra. Tristique senectus et netus et malesuada fames ac. Quis blandit turpis cursus in hac habitasse. Sit amet consectetur adipiscing elit pellentesque habitant. Sapien et ligula ullamcorper malesuada proin libero nunc consequat. Tellus molestie nunc non blandit."
          }
        />
      </Tabs.Panel>
